        ...
        <div class="ems-row ems-row-1">
            <div class="order-result">
                ...
                <div class="order-result-success">
                    <i class="order-success icon-ico_check"></i>
                    <div class="order-result-content">
                        <h1 class="fsize-20">SİPARİŞİNİZ ONAYLANDI</h1>
                        <p><b class="color-1">Sipariş Kodunuz:</b><span class="color-2">763487482092340</span></p>
                    </div>
                </div>
